...
// checks if the GetVirtualMachineMemoryBlocksResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVirtualMachineMemoryBlocksResponseContent{}
