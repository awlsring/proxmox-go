...
// checks if the GetVirtualMachineCloudInitResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVirtualMachineCloudInitResponseContent{}
