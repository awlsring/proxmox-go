...
func NewVirtualMachineConfigurationSummary(digest string) *VirtualMachineConfigurationSummary {
	this := VirtualMachineConfigurationSummary{}
	this.Digest = digest
	return &this
}
...
type NullableVirtualMachineConfigurationSummary struct {
	value *VirtualMachineConfigurationSummary
	isSet bool
}

func (v NullableVirtualMachineConfigurationSummary) Get() *VirtualMachineConfigurationSummary {
	return v.value
}

func (v *NullableVirtualMachineConfigurationSummary) Set(val *VirtualMachineConfigurationSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualMachineConfigurationSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualMachineConfigurationSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualMachineConfigurationSummary(val *VirtualMachineConfigurationSummary) *NullableVirtualMachineConfigurationSummary {
	return &NullableVirtualMachineConfigurationSummary{value: val, isSet: true}
}

func (v NullableVirtualMachineConfigurationSummary) MarshalJSON() ([]byte, error) {
