...
// checks if the CreateLVMThinResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateLVMThinResponseContent{}
