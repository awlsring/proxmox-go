...
// checks if the ListPciDevicesResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListPciDevicesResponseContent{}
